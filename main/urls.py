...
urlpatterns=[
    ...
    path('sign-up-reader', views.sign_up_reader, name="reader_signup"),
    path('sign-up-poster', views.sign_up_poster, name="poster_signup"),
    ...
    path('comment-delete/<int:pk>/', views.Comment_delete_view.as_view(), name='comment-delete')
